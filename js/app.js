...
//   var attempts = 1;
//   var guess = false;
//   var userNumberGuess = prompt(
//     'With 4 attempts, can you guess how many pokemons I caught this week?'
//   );
...
//       console.log(userNumberGuess);
//       userNumberGuess = prompt(
//         'You entered the number: ' + userNumberGuess + ', to LOW!'
//       );
//       attempts++;
//     } else if (userNumberGuess > myNumber) {
//       console.log(userNumberGuess);
//       userNumberGuess = prompt(
//         'You entered the number: ' + userNumberGuess + ', to HIGH!'
//       );
//       attempts++;
//     } else {
//       console.log(userNumberGuess);
...
//         userNumberGuess +
//         ', which is the correct answer, GREAT JOB!'
//     );
...
//       tries++;
//       usersGuess = prompt(
//         'You did not enter a correct color, please try again!'
//       );
//       if (
//         usersGuess === favoriteColors[0] ||
//         usersGuess === favoriteColors[1] ||
